<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stu_info.aspx.cs" Inherits="StudentAccess_info_select" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .btn {max-width: 100px; margin-top:50px;}
    </style>
</head>
<body>
       ...
       <center>
        <table style="width: 600px; margin-top:200px">
         ...
         <asp:HyperLink ID="HyperLink1" runat="server" Font-Size="X-Large" 
               ...
               NavigateUrl="stu_query.aspx" class="btn">返回</asp:HyperLink>
        </center>
